...
public class Kamp {
	...
	// public Deltagelse createDeltagelse(boolean afbud, String begrundelse, Kamp
	// kamp) {
	// Deltagelse deltagelse = new Deltagelse(afbud, begrundelse, kamp);
